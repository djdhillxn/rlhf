...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run N+-style PPO alignment with Hugging Face TRL.")
    parser.add_argument("--config", default="configs/trl/qwen25_05b_helpsteer3_ppo.yaml")
